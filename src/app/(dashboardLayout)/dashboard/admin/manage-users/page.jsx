...
export default function ManageUsers() {
  const [users, setUsers] = useState([
    ...
    {
      id: "u2",
      name: "AK Haolader Transport",
      email: "ak.transport@gmail.com",
      role: "vendor",
      isFraud: false,
    },
    {
    ...
    {
      id: "u4",
      name: "Fake Ticket Provider",
      email: "fake.bus@gmail.com",
      role: "vendor",
      isFraud: true,
    },
  ]);
  ...
  const handleMarkAsFraud = (id, name) => {
    setUsers((prev) =>
      prev.map((user) => (user.id === id ? { ...user, isFraud: true } : user)),
    );
    toast.error(
                ...
                >
                  ...
                  <td className="p-5 text-right pr-8">
                    <div className="flex justify-end items-center gap-2">
                      <button
                        onClick={() =>
                          handleRoleChange(member.id, "admin", member.name)
                        }
                      ...
                      <button
                        onClick={() =>
                          handleRoleChange(member.id, "vendor", member.name)
                        }
                      ...
                      {member.role === "vendor" && (
                        <button
                          onClick={() =>
                            handleMarkAsFraud(member.id, member.name)
                          }
